            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                {dashboardStats.map((stat, i) => (
                    <Link 
                        key={i} 
                        to={stat.link}
                        className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group cursor-pointer"
                    >
                        ...
                        <div className="flex items-center justify-between mt-3">
                            <div className={`h-1 w-10 rounded-full bg-gradient-to-r ${stat.color}`}></div>
                            <span className="text-xs text-gray-400 group-hover:text-blue-600 transition-colors">View details →</span>
                        </div>
                    </Link>
                ))}
            </div>
